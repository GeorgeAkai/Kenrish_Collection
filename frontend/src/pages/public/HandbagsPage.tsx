    ...
    <div>
      ...
      <section className="py-14 px-5 text-center bg-secondary/40">
        <div className="max-w-2xl mx-auto">
          <p className="text-xs font-semibold text-primary mb-2.5 tracking-[0.18em] uppercase">Designer Selection</p>
          <h1
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            Timeless designs &amp; statement pieces — handpicked for the modern woman.
          </p>
          {data && <p className="text-xs text-muted-foreground mt-3">{data.count} bags available</p>}
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {loading ? (
          ...
          <>
            ...
            {data?.count === 0 && (
              <p className="text-center text-muted-foreground py-20">No handbags available yet.</p>
            )}
